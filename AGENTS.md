...
- Coder реализует участок и тесты; verifier выполняет недостающие проверки;
  reviewer оценивает AC и delta участка. Проверки coder принимаются с актуальным
  evidence; обязательный повтор verifier не нужен.
