...
| --- | --- | --- | --- | --- | --- |
| G0 | Specification and Android tooling | — | done | G0 commit | docs; `claude-in-mobile` 4.4.1 Android doctor passes |
| G1 | FSM, DAG, and invariant domain | G0 | pending | — | domain tests |
