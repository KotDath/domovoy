...
решения, пути, проверки, зависимости и блокеры. Для T2 сформулируйте затронутый
рискованный контракт и проверяемые негативные сценарии. Не требуйте раскрыть
